      ...
      <div className='relative w-full h-auto'>
        <div className=''>
          ...
          <div className='absolute inset-0 text-white mx-4 my-10 sm:m md:mx-12 md:my-20 lg:mx-24 lg:my-36 xl:mx-24 xl:my-36 w-[18rem] sm:w-[22rem] md:w-[26rem] lg:w-[40rem] xl:w-[40rem]'>
            ...
            <h1 className='text-sm md:text-base lg:text-xl xl:text-xl lg:my-1 xl:my-1 text-white' data-aos="fade-up">MERN Stack Developer</h1>

            <button onClick={() => {
              if (typeof window !== "undefined") {
                document.getElementById('contact').scrollIntoView({ behavior: 'smooth' })
              }
            }} data-aos="fade-left" className='w-[5rem] md:w-[8rem] lg:w-32 xl:w-32 h-7 md:h-9 lg:h-10 xl:h-10 bg-sky-600 text-white mt-2 text-xs md:text-base lg:text-lg xl:text-lg hover:bg-white hover:text-sky-600 rounded'>Contact Me</button>
          </div>
