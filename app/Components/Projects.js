...
const Projects = () => {
    ...
    const showRentCarMessage = () => setRentcarMessage(!rentcarMessage);
                        ...
                        <div className='grid grid-cols-2'>
                            ...
                            <div className='px-4 sm:px-3 md:px-5 lg:px-0 xl:px-0 flex flex-col justify-center wow animate__animated animate__backInRight'>
                                ...
                                <div>
                                    ...
                                    <button onClick={playAudio} className='hidden lg:inline-block xl:inline-block lg:w-24 lg:h-10 lg:text-base xl:w-24 xl:h-10 xl:text-base bg-sky-600 text-white rounded mt-2 hover:bg-white hover:text-sky-600'>Live Demo</button>
                                    <button onClick={playAudio} className='hidden lg:inline-block xl:inline-block lg:w-24 lg:h-10 lg:text-base xl:w-24 xl:h-10 xl:text-base bg-sky-600 text-white rounded mt-2 hover:bg-white hover:text-sky-600 mx-2 sm:mx-3 md:mx-4 lg:mx-5 xl:mx-5'>Source</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className='grid grid-cols-2 my-10'>
                            ...
                            <div className='px-4 sm:px-3 md:px-5 lg:px-0 xl:px-0 flex flex-col justify-center wow animate__animated animate__backInRight'>
                                ...
                                <p className='hidden md:text-sm lg:text-base xl:text-base lg:block'>I developed a Quiz Management App using Java with a GUI. The app allows users to create, manage,
                                    ...
                                    <button onClick={playAudio} className='hidden lg:inline-block xl:inline-block md:w-[6rem] md:text-sm lg:w-24 lg:h-10 lg:text-base xl:w-24 xl:h-10 xl:text-base bg-sky-600 text-white rounded mt-2 hover:bg-white hover:text-sky-600'>Live Demo</button>
                                    <button onClick={playAudio} className='hidden lg:inline-block xl:inline-block md:w-[6rem] md:text-sm lg:w-24 lg:h-10 lg:text-base xl:w-24 xl:h-10 xl:text-base bg-sky-600 text-white rounded mt-2 hover:bg-white hover:text-sky-600 mx-2 sm:mx-3 md:mx-4 lg:mx-5 xl:mx-5'>Source</button>
                                </div>
                            </div>
