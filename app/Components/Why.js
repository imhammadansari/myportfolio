  ...
  return (
    <>
      <div className='w-full'>
        <div className='relative mx-auto mt-12 lg:mt-16 xl:mt-16 grid  animate__animated animate__zoomIn'>
          ...
          <div className='absolute w-full h-full flex flex-col lg:flex-row xl:flex-row gap-0 md:gap-2 lg:gap-4 xl:gap-4 p-3 items-center justify-center'>
            ...
            <div className='bg-white p-1 lg:p-5 xl:p-5 text-center bg-opacity-90 mt-0 lg:mt-6 xl:mt-6  animate__animated animate__backInLeft transition-transform duration-300 hover:scale-90'>
            ...
            <div className='bg-white  animate__animated animate__backInUp p-1 lg:p-5 xl:p-5 text-center bg-opacity-90 mt-4 lg:mt-6 xl:mt-6 transition-transform duration-300 hover:scale-90'>
            ...
            <div className='bg-white  animate__animated animate__backInRight p-1 lg:p-5 xl:p-5 text-center bg-opacity-90 mt-4 lg:mt-6 xl:mt-6 transition-transform duration-300 hover:scale-90'>
