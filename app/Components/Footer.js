                    ...
                    <div>
                        ...
                        <div className='space-y-3'>
                            <div className='flex items-center gap-3'>
                                ...
                                <a href='tel:+923282020955' className='text-gray-400 text-sm'>+92-3282020955</a>
                            </div>
                            <div className='flex items-center gap-3'>
                                <svg className="w-5 h-5 text-[#d062a0]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                </svg>
                                <a href='mailto:ansarihamad084@gmail.com' className='text-gray-400 text-sm'>ansarihamad084@gmail.com</a>
                            </div>
                            <div className='flex items-center gap-3'>
                                <svg className="w-5 h-5 text-[#d062a0]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
